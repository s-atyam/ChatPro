...
const Messages = (props) => {
  ...
  return (
    <div className={`border backdrop-blur-lg w-fit max-w-[80%] h-fit min-h-fit   my-1 p-2 border-slate-300 rounded-t-xl text-xs ${props.direction==="left"?'rounded-ee-xl ':'ml-auto  bg-cyan-100 rounded-es-xl  text-slate-700'}`}>
      <p className='font-medium '>{props.txt}</p>
