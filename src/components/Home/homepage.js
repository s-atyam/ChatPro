...
const Homepage = () => {
  return (
    <div className="w-screen h-screen bg-slate-900 flex flex-col">
      <nav className="h-fit w-full flex justify-around items-center mt-5 overflow-hidden">
        <div className="w-1/3 flex md:w-[12%]  md:mr-12">
          <img src={logo_dp} alt="" />
        </div>
        <div className="w-fit h-fit">
          <button className="border-2 font-medium text-lg border-blue-500 text-blue-500 mx-2 px-3 py-1 rounded-sm hover:text-blue-900 hover:border-blue-900">
            Signup
          </button>
          <button className="border-2 font-medium text-lg border-green-500 text-green-500 mx-2 px-3 py-1 rounded-sm hover:text-green-900 hover:border-green-900">
            Login
          </button>
        </div>
      </nav>
      <div className="text-slate-400 w-full h-fit md:h-5/6 mb-36 md:mb-0 flex justify-center items-center flex-wrap">
        ...
        <div className="w-5/6  md:w-2/5 h-fit flex flex-col ">
          ...
          <button className="border-2 border-slate-400 font-semibold w-fit text-xs px-8 py-2 rounded-md hover:text-blue-500 hover:border-blue-500">
            Get Started
          </button>
        </div>
      </div>
